...
if (isset($_REQUEST['eliminar'])) { //pregunto si le llego la variable 
    $id_cliente= $_REQUEST['id_cliente']; //la cargamos en una variable

    require_once("conexion.php"); //conexion a la bd

    $resultado_baja= mysqli_query($conex,"DELETE FROM clientes WHERE id_cliente = $id_cliente") //busca la coincidencia del id seleccioando con el id de la db
