...
if (isset($_REQUEST['eliminar'])) { //pregunto si le llego la variable 
    $id_marca= $_REQUEST['id_marca']; //la cargamos en una variable

    require_once("conexion.php"); //conexion a la bd

    $resultado_baja= mysqli_query($conex,"DELETE FROM marca_mp WHERE id_marca = $id_marca") //busca la coincidencia del id seleccioando con el id de la db
