...
if (isset($_REQUEST['eliminar'])) { //pregunto si le llego la variable 
    $id_categoria_gasto= $_REQUEST['id_categoria_gasto']; //la cargamos en una variable

    require_once("conexion.php"); //conexion a la bd

    $resultado_baja= mysqli_query($conex,"DELETE FROM categoria_gasto WHERE id_categoria_gasto = $id_categoria_gasto") //busca la coincidencia del id seleccioando con el id de la db
